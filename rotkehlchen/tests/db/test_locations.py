...
def test_associated_locations(database):
    ...
    database.add_amm_events([
        LiquidityPoolEvent(
            ...
            token0=EvmToken('0x514910771AF9Ca656af840dff83E8264EcF986CA'),
            token1=EvmToken('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'),
    ...
    database.add_amm_swaps([
        AMMSwap(
            ...
            token0=EvmToken('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'),
            token1=EvmToken('0xdAC17F958D2ee523a2206206994597C13D831ec7'),
    ...
    database.add_balancer_events([
        BalancerEvent(
            ...
            pool_address_token=EvmToken('0x514910771AF9Ca656af840dff83E8264EcF986CA'),

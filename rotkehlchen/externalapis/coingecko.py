...
DELISTED_ASSETS = [
    ethaddress_to_identifier('0x0F72714B35a366285Df85886A2eE174601292A17'),
    'FLUZ',
    'EBCH',
    'GOLOS',
    'NPER',
    ethaddress_to_identifier('0xCA29db4221c111888a7e80b12eAc8a266Da3Ee0d'),
    'ADN',
    'PIX',
    ethaddress_to_identifier('0xdfdc0D82d96F8fd40ca0CFB4A288955bECEc2088'),
    'LKY',
    ethaddress_to_identifier('0xaFBeC4D65BC7b116d85107FD05d912491029Bf46'),
    ethaddress_to_identifier('0x37D40510a2F5Bc98AA7a0f7BF4b3453Bcfb90Ac1'),
    'BITCAR',
    ...
    'VIN',
    'FIH',
    ethaddress_to_identifier('0x899338b84D25aC505a332aDCE7402d697D947494'),
    'ADH',
    'AUR',
    ethaddress_to_identifier('0x2A05d22DB079BC40C2f77a1d1fF703a56E631cc1'),
    'BYC',
    'DGS',
    ethaddress_to_identifier('0xb3Bd49E28f8F832b8d1E246106991e546c323502'),
    'HST',
    'INS',
    'IPSX',
    'SHP',
    ...
    'REDC',
    'SGN',
    ethaddress_to_identifier('0xD65960FAcb8E4a2dFcb2C2212cb2e44a02e2a57E'),
    ethaddress_to_identifier('0xD9A12Cde03a86E800496469858De8581D3A5353d'),
    'AC',
    ethaddress_to_identifier('0x4C0fBE1BB46612915E7967d2C3213cd4d87257AD'),
    'BITPARK',
    ethaddress_to_identifier('0xB4b1D2C217EC0776584CE08D3DD98F90EDedA44b'),
    'DAN',
    ethaddress_to_identifier('0x89c6c856a6db3e46107163D0cDa7A7FF211BD655'),
    ethaddress_to_identifier('0x07e3c70653548B04f0A75970C1F81B4CBbFB606f'),
    'DROP',
    'ERD',
    'ETBS',
    ethaddress_to_identifier('0x543Ff227F64Aa17eA132Bf9886cAb5DB55DCAddf'),
    'STP',
    'SYNC',
    'TBT',
    'TNT',
    'WIC',
    'XCN',
    ethaddress_to_identifier('0x6368e1E18c4C419DDFC608A0BEd1ccb87b9250fc'),
    'FREC',
    'PTC',
    ethaddress_to_identifier('0x13F1b7FDFbE1fc66676D56483e21B1ecb40b58E2'),
    'J8T',
    'MRK',
    'TTV',
    'ALX',
    ...
    'RCN-2',
    'SKYM',
    ethaddress_to_identifier('0xFA456Cf55250A839088b27EE32A424d7DAcB54Ff'),
    ethaddress_to_identifier('0x12fCd6463E66974cF7bBC24FFC4d40d6bE458283'),
    ethaddress_to_identifier('0x3A1237D38D0Fb94513f85D61679cAd7F38507242'),
    ethaddress_to_identifier('0xf333b2Ace992ac2bBD8798bF57Bc65a06184afBa'),
    ethaddress_to_identifier('0xAf30D2a7E90d7DC361c8C4585e9BB7D2F6f15bc7'),
    'aLEND',
    'aREP',
    'CRBT',
    'EXC-2',
    ethaddress_to_identifier('0x1da015eA4AD2d3e5586E54b9fB0682Ca3CA8A17a'),
    'CZR',
    'ROCK2',
    'ATMI',
    ethaddress_to_identifier('0x9B11EFcAAA1890f6eE52C6bB7CF8153aC5d74139'),
    ethaddress_to_identifier('0xc88Be04c809856B75E3DfE19eB4dCf0a3B15317a'),
    'CREDO',
    'ETK',
    'FNKOS',
    ethaddress_to_identifier('0x2AEC18c5500f21359CE1BEA5Dc1777344dF4C0Dc'),
    'GIM',
    ethaddress_to_identifier('0xA4eA687A2A7F29cF2dc66B39c68e4411C0D00C49'),
    'KORE',
    'NBAI',
    ethaddress_to_identifier('0xfeDAE5642668f8636A11987Ff386bfd215F942EE'),
    'XEL',
    'ATS',
    'BCY',
    ...
    'VIEW',
    'VRM',
    ethaddress_to_identifier('0xdF1D6405df92d981a2fB3ce68F6A03baC6C0E41F'),
    'SPF',
    'NOBS',
    'DADI',
    ethaddress_to_identifier('0x22dE9912cd3D74953B1cd1F250B825133cC2C1b3'),
    ethaddress_to_identifier('0xAa0bb10CEc1fa372eb3Abc17C933FC6ba863DD9E'),
    ethaddress_to_identifier('0x1BcBc54166F6bA149934870b60506199b6C9dB6D'),
    ethaddress_to_identifier('0x851017523AE205adc9195e7F97D029f4Cfe7794c'),
    ethaddress_to_identifier('0x7f65BE7FAd0c22813e51746E7e8f13a20bAa9411'),
    ethaddress_to_identifier('0xe431a4c5DB8B73c773e06cf2587dA1EB53c41373'),
    ethaddress_to_identifier('0xAef38fBFBF932D1AeF3B808Bc8fBd8Cd8E1f8BC5'),
    ethaddress_to_identifier('0xd341d1680Eeee3255b8C4c75bCCE7EB57f144dAe'),
    'FLO',
    ethaddress_to_identifier('0x06147110022B768BA8F99A8f385df11a151A9cc8'),
    ethaddress_to_identifier('0x27695E09149AdC738A978e9A678F99E4c39e9eb9'),
    'FCN',
    'BITB',
    'SMC',
    'POP',
    ...
    'BSD',
    'BITS',
    ethaddress_to_identifier('0x1695936d6a953df699C38CA21c2140d497C08BD9'),
    ethaddress_to_identifier('0xD6014EA05BDe904448B743833dDF07c3C7837481'),
    ethaddress_to_identifier('0x054C64741dBafDC19784505494029823D89c3b13'),
    ethaddress_to_identifier('0x2ecB13A8c458c379c4d9a7259e202De03c8F3D19'),
    ethaddress_to_identifier('0x4a6058666cf1057eaC3CD3A5a614620547559fc9'),
    ethaddress_to_identifier('0x6F919D67967a97EA36195A2346d9244E60FE0dDB'),
    ethaddress_to_identifier('0x8dB54ca569D3019A2ba126D03C37c44b5eF81EF6'),
    ethaddress_to_identifier('0xb62d18DeA74045E822352CE4B3EE77319DC5ff2F'),
    ethaddress_to_identifier('0x884181554dfA9e578d36379919C05C25dC4a15bB'),
    ethaddress_to_identifier('0xfF18DBc487b4c2E3222d115952bABfDa8BA52F5F'),
    ethaddress_to_identifier('0x957c30aB0426e0C93CD8241E2c60392d08c6aC8e'),
    ethaddress_to_identifier('0x263c618480DBe35C300D8d5EcDA19bbB986AcaeD'),
    ethaddress_to_identifier('0x076C97e1c869072eE22f8c91978C99B4bcB02591'),
    ethaddress_to_identifier('0x8eFFd494eB698cc399AF6231fCcd39E08fd20B15'),
    ethaddress_to_identifier('0x53066cdDBc0099eb6c96785d9b3DF2AAeEDE5DA3'),
    ethaddress_to_identifier('0x9214eC02CB71CbA0ADA6896b8dA260736a67ab10'),
    ethaddress_to_identifier('0xabC1280A0187a2020cC675437aed400185F86Db6'),
    ethaddress_to_identifier('0x23b75Bc7AaF28e2d6628C3f424B3882F8f072a3c'),
    'BTCS',
    ethaddress_to_identifier('0x491C9A23DB85623EEd455a8EfDd6AbA9b911C5dF'),
    ethaddress_to_identifier('0x8aA33A7899FCC8eA5fBe6A608A109c3893A1B8b2'),
    'ARB-2',
    'BAY',
    'UNITY',
    ethaddress_to_identifier('0x8d80de8A78198396329dfA769aD54d24bF90E7aa'),
    ethaddress_to_identifier('0x5bEaBAEBB3146685Dd74176f68a0721F91297D37'),
    ethaddress_to_identifier('0x82f4dED9Cec9B5750FBFf5C2185AEe35AfC16587'),
    ethaddress_to_identifier('0x74CEDa77281b339142A36817Fa5F9E29412bAb85'),
    ethaddress_to_identifier('0xDDe12a12A6f67156e0DA672be05c374e1B0a3e57'),
    ethaddress_to_identifier('0x2bDC0D42996017fCe214b21607a515DA41A9E0C5'),
    ethaddress_to_identifier('0x1c79ab32C66aCAa1e9E81952B8AAa581B43e54E7'),
    ethaddress_to_identifier('0xD3C00772B24D997A812249ca637a921e81357701'),
    'DCT',
    'NOTE',
    'SLR',
    'SXC',
    ethaddress_to_identifier('0x6fFF3806Bbac52A20e0d79BC538d527f6a22c96b'),
]
